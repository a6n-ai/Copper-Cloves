    ...
    () => [
      {
        ...
        description: "Consecutive days you've attended a class",
      },
      { label: "On time", value: attendanceCounts.on_time, icon: CheckCircle, tone: "up", description: "Classes you checked in to on time" },
      { label: "Late", value: attendanceCounts.late, icon: Clock, tone: "warn", description: "Classes you checked in to after the class started" },
      { label: "No-shows", value: attendanceCounts.no_show, icon: AlertCircle, tone: "down", description: "Classes you booked but didn't check in to" },
    ],
