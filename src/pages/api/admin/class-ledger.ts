...
/** Synthetic class ledger from bookings + package grants for the admin Class Ledger page. */
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const rows = [...usedRows, ...addedRows, ...expiredRows].sort((a, b) => b.date.localeCompare(a.date));
