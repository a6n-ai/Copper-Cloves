    ...
    <footer className="bg-sage text-cream">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-[#fafaf8]/10 hover:bg-[#fafaf8]/20 transition-colors duration-300 flex items-center justify-center group"
              >
              ...
              <a 
                ...
                className="w-10 h-10 rounded-full bg-[#fafaf8]/10 hover:bg-[#fafaf8]/20 transition-colors duration-300 flex items-center justify-center group"
              >
                <Facebook size={20} className="text-cream" />
              </a>
              <a 
                ...
                className="w-10 h-10 rounded-full bg-[#fafaf8]/10 hover:bg-[#fafaf8]/20 transition-colors duration-300 flex items-center justify-center group"
              >
                <Youtube size={20} className="text-cream" />
              </a>
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-display text-xl text-cream mb-6">Quick Links</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/classes" className="font-body text-cream/70 hover:text-cream transition-colors duration-300">
                  Class Schedule
                </Link>
              </li>
              <li>
                <Link href="/cafe" className="font-body text-cream/70 hover:text-cream transition-colors duration-300">
                  The Café
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/portal/login" className="font-body text-cream/70 hover:text-cream transition-colors duration-300">
                  Member Portal
                </Link>
              </li>
            </ul>
          ...
          {/* Classes */}
          <div>
            <h3 className="font-display text-xl text-cream mb-6">Our Classes</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/classes" className="font-body text-cream/70 hover:text-cream transition-colors duration-300">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="font-display text-xl text-cream mb-6">Get in Touch</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="text-cream mt-1 shrink-0" size={20} />
                <div className="font-body text-cream/70 leading-relaxed">
              ...
              <li className="flex items-center gap-3">
                <Phone className="text-cream shrink-0" size={20} />
                <a href="tel:+919008426703" className="font-body text-cream/70 hover:text-cream transition-colors duration-300">
                  +91 90084 26703
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="text-cream shrink-0" size={20} />
                <a href="mailto:thestudio@copperandcloves.com" className="font-body text-cream/70 hover:text-cream transition-colors duration-300">
        ...
        <div className="border-t border-cream/20 pt-12 mb-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            {/* Embedded Map */}
            <div className="rounded-xl overflow-hidden shadow-[0_8px_48px_-8px_rgba(51,51,51,0.14)] h-[200px] sm:h-[220px] md:h-[240px] max-w-lg mx-auto md:max-w-none md:mx-0 md:ml-auto">
              <iframe
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <Link href="/policy" className="font-body text-cream/60 hover:text-cream text-sm transition-colors duration-300">
                Privacy Policy
              </Link>
              <Link href="/terms" className="font-body text-cream/60 hover:text-cream text-sm transition-colors duration-300">
                Terms of Service
              </Link>
            </div>
          </div>
