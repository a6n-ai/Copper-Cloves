                  ...
                  <div className="relative h-full bg-white-warm rounded-2xl border border-sage/10 overflow-hidden transition-all duration-500 hover:border-sage/30 hover:shadow-xl hover:bg-sage/5">
                    ...
                    <div className="p-6">
                      ...
                      <Link
                        ...
                        className="block w-full py-3 rounded-full border border-sage/30 text-sage font-body text-sm text-center hover:bg-sage hover:text-cream transition-all duration-300 group-hover:border-sage"
                      >
                        view details
                      </Link>
                    </div>
