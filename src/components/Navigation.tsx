...
function navShellClass(isOverlay: boolean, scrolled: boolean) {
  return cn(
    ...
    isOverlay && [
      ...
      scrolled
        ? "bg-cream border-b border-charcoal/10 shadow-xs"
        // Solid on mobile (transparent reads as "no navbar"); transparent over the hero on md+.
        : "bg-cream border-b border-charcoal/10 shadow-xs md:border-transparent md:bg-transparent md:shadow-none",
    ],
    !isOverlay && [
      "sticky top-0 z-50 border-b",
      scrolled
        ? "bg-cream border-charcoal/10 shadow-xs"
