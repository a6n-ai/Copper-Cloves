...
export const INNER_PAGES: Partial<Record<PortalKind, InnerPage[]>> = {
  admin: [
    ...
    { label: "Manual Entries · Money In", href: "/admin/manual-entries?tab=money_in" },
    { label: "Manual Entries · Money Out", href: "/admin/manual-entries?tab=expenses" },
    { label: "Manual Entries · Payouts", href: "/admin/manual-entries?tab=payouts" },
